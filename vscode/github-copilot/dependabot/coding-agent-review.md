...
- **Linter**: [✅ Pass / ❌ Fail] - [詳細]
- **型チェック**: [✅ Pass / ❌ Fail] - [詳細]
- **コード品質**: [✅ Pass / ⚠️ Warning / ❌ Fail] - [詳細]

### セキュリティチェック
- **脆弱性スキャン**: [✅ Pass / ⚠️ Warning / ❌ Critical] - [詳細]
- **依存関係監査**: [✅ Pass / ⚠️ Warning / ❌ Fail] - [詳細]

### 機能テスト
- **基本機能**: [✅ Pass / ❌ Fail] - [テスト内容]
- **エラーハンドリング**: [✅ Pass / ❌ Fail] - [テスト内容]
- **パフォーマンス**: [✅ Pass / ⚠️ 注意 / ❌ 劣化] - [測定結果]
